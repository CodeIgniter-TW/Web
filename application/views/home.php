<div id="wrapperWit">
    <div id="gooey">
        <div id="home_banner">
            ...
            <ul>
                <li><a href="<?=base_url();?>downloads/file/CodeIgniter_2.1.3" class="home_banner_links"><img src="/assets/images/design/icon_download.png" alt="icon_download" width="32" height="32" />下載 CodeIgniter<br />
                  <em>版本 2.1.3</em></a></li>
