<div id="wrapperWit">
    <div id="gooey">
        <div id="home_banner">
            ...
            <ul>
                <li><a href="<?=base_url();?>downloads/file/CodeIgniter_3.0.4" class="home_banner_links"><img src="/assets/images/design/icon_download.png" alt="icon_download" width="32" height="32" />下載 CodeIgniter<br />
                  <em>版本 3.0.4</em></a></li>
