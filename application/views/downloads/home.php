    ...
    <div id="gooey">
        <div id="content">
            ...
            <div id="currentVersion">
                ...
                <p>CodeIgniter 目前版本是 2.1.3，參考 <a href="<?=base_url();?>user_guide/changelog.html">Change Log</a></p>
                ...
                <div id="currentVersionLink">
                    <a href="<?=base_url();?>downloads/file/CodeIgniter_2.1.3"><em>版本 2.1.3</em></a>
                </div>
            </div>
            <div id="subversion">
                <h3>GitHub 網站</h3>
